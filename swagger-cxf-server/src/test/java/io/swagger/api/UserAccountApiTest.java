...
public class UserAccountApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://localhost:443/security/v1", UserAccountApi.class, providers);
    ...
    public void deleteUserAccountsTest() {
        String id = null;
        List<Account> body = null;
        //api.deleteUserAccounts(id, body);
    ...
    public void getUserAccountsTest() {
        Integer id = null;
        //List<Account> response = api.getUserAccounts(id);
    ...
    /**
     * Updated user / account assignment (upsert)
     *
     * This can only be done by the logged in user.
     *
     * @throws ApiException
    ...
    public void updateUserAccountsTest() {
        String id = null;
        List<Account> body = null;
        //Account response = api.updateUserAccounts(id, body);
        //assertNotNull(response);
        // TODO: test validations
